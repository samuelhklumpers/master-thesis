...
This construction is an instance of the concept of ``well-founded recursion''\footnote{This is formalized in the \hyperlink{standard-library}{https://agda.github.io/agda-stdlib/Induction.WellFounded.html} with many other examples.}, so we let ourselves be inspired by these methods. In particular, we prove an irrelevance lemma

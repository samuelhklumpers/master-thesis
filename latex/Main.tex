...
In this section, we will describe the ornamental descriptions for the \AD{DescI} universe, and explain their working by means of examples. We omit the definition of the ornaments, since will be constructing new datatypes, rather than relating pre-existing ones.

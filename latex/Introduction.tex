...
%\towrite{Why program verification}

%\towrite{Lists and vectors}

%\towrite{Numerical representations}

%\towrite{To control the consequences of type isomorphisms, we move to cubical type theory}

%\towrite{Adding invariants to get correctness by construction, which entails ornaments}
...
\toremove{The relations between the sections can be summarized as}
